...
for cluster_id in range(num_clusters):
    ...
    for gammaB in gammaB_values:
        ...
        for r in np.arange(r_start, r_end + 1, 50):
...
# # 3️⃣ T values
# T_vals = np.arange(200, 5000, 100) #np.arange(200, 5000, 200)
# avg_losses = []
# utilities = []
...
#         utility = avg_loss +0.0000213359 * T  #0.000001 #0.0000123351    0.0000213359   0.0000213359
